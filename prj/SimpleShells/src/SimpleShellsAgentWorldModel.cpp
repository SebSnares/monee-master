...
SimpleShellsAgentWorldModel::SimpleShellsAgentWorldModel() {
	...
	gProperties.checkAndGetPropertyValue("gSpecialisation", &_specialisation, false); //Switch on/off _specialisation here to penalize velocity for not Mutually Exclusive collection
